          ...
          render: (text, record) => (
            <div>
              ...
              <Button
                ...
                style={{marginRight: '5px'}}
                onClick={() => {
                  this.props.to(`${this.props.match.path}/management/position/${record.id}`)
                }}
              >
                捆绑设备
              </Button>
              <Button
                size="small"
                className={!record.active ? 'buttonListSixth' :  "buttonListMoreTwo"}
                disabled={!record.active}
                style={{marginRight: '5px'}}
                onClick={() => {
                  this.props.to(`${this.props.match.path}/management/agent/${record.id}`)
                }}
              >
                捆绑代理商
              </Button>
